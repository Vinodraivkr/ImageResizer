package vkr.aws.image_processor;
...
public class ImageResizerLambdaTest {
    ...
    public void testHandleRequest() {
        ...
        // Act
        APIGatewayProxyResponseEvent response = imageResizerLambda.handleRequest(request, context);

        // Assert
        assertEquals(200, response.getStatusCode());
        assertEquals("Image resized and uploaded successfully.", response.getBody());

        // Verify that putObject was called with a valid request and RequestBody
